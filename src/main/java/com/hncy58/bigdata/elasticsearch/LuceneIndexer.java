...
public interface LuceneIndexer extends LuceneSearcher
{
	 ...
	 * @param id			索引文档id
	 * @param row			索引文档内容
	 * @param routeValue    路由值
	 */
	public void index(String datasource, String table, Map<String, Object> row, String routeValue) throws SearchEngineException;

	public void index(String indice, String table, Map<String, Object> row, boolean batchCommit) throws SearchEngineException;
	/**
	 * 更新索引记录
	 * @param datasource	索引库
	 * @param table			文档所属表
	 * @param SQL			查询索引记录行的语句
	 */
	 ...
	 * @param table			文档所属表
	 * @param SQL			查询语句
	 * @param keyFieldName	语句查询字段列表中的主键字段名称
	 * @param dsName        数据源
	 * @param parameters	查询语句的参数
	 * @throws SearchEngineException
	 */
	public void indexAll(String datasource, String table, String SQL, String keyFieldName, String dsName, Object... parameters) throws SearchEngineException;
	
	public void indexAllWithRowMapper(String db, String table, String SQL, String keyFieldName,String dsName, Object... parameters) throws SearchEngineException;
	 ...
	 * @throws SearchEngineException
	 */
	public void indexAll(String essource, String table, List<Map<String,Object>> list, String keyFieldName) throws SearchEngineException;
	 ...
	 * @param list			需索引的文档列表
	 * @param keyFieldName  语句查询字段列表中的主键字段名称
	 * @param needIndexKeyField 主键字段是否需要单独进行索引
	 * @throws SearchEngineException
	 */
	public void indexAll(String essource, String table, List<Map<String,Object>> list, String keyFieldName, Boolean needIndexKeyField) throws SearchEngineException;
	 ...
	 * @throws SearchEngineException
	 */
	public void indexAll(String essource, String table, List<Map<String,Object>> list, String keyFieldName, String routeValue) throws SearchEngineException;
